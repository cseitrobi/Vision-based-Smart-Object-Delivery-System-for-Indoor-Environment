...
# Serial Initialization use your own port befor running
ser = serial.Serial('/dev/ttyACM0', 9600, timeout=1) # you will need to change '/dev/ttyACM0' part with your own
...
# Serial Initialization use your own port befor running
ser = serial.Serial('/dev/ttyACM1', 9600, timeout=1)  # you will need to change '/dev/ttyACM0' part with your own
servo = Servo(25)
